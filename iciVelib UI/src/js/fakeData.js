export const FakeData = {
    ...
    favoriteStations: [],
    fakeAsyncCallMobile(callback, result, delayMillis) {
        setTimeout(() => {
            callback.call(window, { result: result });
        }, delayMillis);
    },
    getVelibStations() {
        return this.getVelibStationDtos();
    },
    getFavoriteVelibStations() {
        return this.getFavoriteVelibStationsDtos();
    },
    getPhoneLocation() {
        return {
            lat: 48.8534,
    ...
    addFavoriteVelibStation(stationId, customLabel) {
        this.favoriteStations.push({
            id: stationId,
    ...
    removeFavoriteVelibStation(stationId) {
        this.favoriteStations = this.favoriteStations.filter(s => s.id !== stationId);
    },
    updateFavoriteVelibStationCustomLabel(stationId, customLabel) {
        this.favoriteStations.find(s => s.id === stationId).customLabel = customLabel;
    }
